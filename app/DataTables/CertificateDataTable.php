...
class CertificateDataTable extends DataTable
{
    ...
    {
        return $model->query()->join("event", "event.id", "=", "certificate.event_id")->select("certificate.link", "certificate.id", "certificate.created_at", "eventName");
    }
    ...
    protected function getColumns()
    {
        $columns = array(
            ...
            Column::make("created_at")->title("Pembuatan Sertifikat")->searchable(false),
