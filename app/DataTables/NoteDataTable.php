...
class NoteDataTable extends DataTable
{
    ...
    {
        return $model->getAll()->select("note.note", "event.eventName as event", "note.id as id", "note.created_at");
    }
    ...
    protected function getColumns()
    {
        $columns = array(
            ...
            Column::make("created_at")->title("Tanggal Dibuat")->searchable(false)->orderable(false),
        );
