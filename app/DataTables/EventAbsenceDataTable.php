...
class EventAbsenceDataTable extends DataTable
{
    ...
    {
        return $model->query()->where("event_id", "=", $this->id)->join("event", "event.id", "=", "event_absence.event_id")->select("event_absence.id", "event_absence.email", "event_absence.nim", "event_absence.university", "event_absence.created_at", "event_absence.status", "event_absence.isPaidOff");
    }
    ...
    protected function getColumns()
    {
        $columns = array(
            ...
            Column::make('created_at')->title("Waktu Pendaftaran")->orderable(false)->searchable(false),
        );
