...
class memberMeetAbsenceDataTable extends DataTable
{
    ...
    {
        return $model->query()->join("meet", "meet.id", "=", "meet_absence.meet_id")->where("meet_absence.member_id", "=", auth()->user()->member->id)->select("meet.id", "meetName", "meet_absence.created_at", "meet_absence.status");
    }
