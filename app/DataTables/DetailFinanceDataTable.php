...
class DetailFinanceDataTable extends DataTable
{
    ...
    public function query(DetailFinance $model)
    {
        return $model
            ...
            ->select("member.name", "member.nim", "detail_finance.created_at", "detail_finance.paymentMethod", "detail_finance.status",  "detail_finance.cash", "detail_finance.id", "receipt.image");
    }
    ...
    protected function getColumns()
    {
        $columns = array(
            ...
            Column::make('created_at')->title("Waktu Pembayaran")->orderable(false)->searchable(false),
