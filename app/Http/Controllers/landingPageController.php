...
class landingPageController extends Controller
{
    ...
    {
        $title = "Beranda";
        $events = Event::query()->orderBy("created_at", "DESC")->take(8)->where("isGeneral", "=", true)->get(array("id", "eventName", "banner", "startAt", "location",  "isOnline", "price"));
        ...
        $galleries = gallery::query()->orderBy("created_at", "DESC")->take(6)->get(array("image"));
    ...
    {
        $title = "Acara " . $id;
        $event = Event::query()->where("id", "=", $id)->first(array("banner", "eventName", "id", "startAt", "description", "price", "isOnline", "detailLocation", "feedback", "location", "payment", "created_at", "contactPerson", "status", "endAt"));
