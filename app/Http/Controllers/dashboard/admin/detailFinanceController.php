...
class detailFinanceController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $finance = $this->financialService->detailFinance($id, array("member.name", "member.nim", "member.phoneNumber", "detail_finance.created_at", "detail_finance.paymentMethod", "detail_finance.status", "finance.penalty", "detail_finance.cash", "detail_finance.id", "receipt.image", "finance.price", "finance.month", "finance.payment", "finance.id as finance_id"));
