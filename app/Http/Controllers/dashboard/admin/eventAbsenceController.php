...
class eventAbsenceController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $event = $this->absenceService->detailAbsenceEvent($id, array("event_absence.id AS absence_id", "event_absence.created_at", "event_absence.status", "event_absence.email", "event_absence.nim", "event_absence.university",  "event.id", "event.location", "event_absence.isPaidOff"));
    ...
    public function export($event)
    {
        ...
        $members = EventAbsence::query()->where("event_id", "=", $event)->join("event", "event.id", "=", "event_absence.event_id")->get(array("event_absence.id", "event_absence.email", "event_absence.nim", "event_absence.university", "event_absence.created_at", "event_absence.status", "event.updatedAt"));
