...
class financeController extends Controller
{
    ...
    public function history()
    {
        ...
        $histories = $this->detailFinanceRepository
            ...
            ->get(array("finance.month", "receipt.image", "detail_finance.status", "detail_finance.paymentMethod", "detail_finance.created_at", "detail_finance.cash"));
    ...
    public function export()
    {
        ...
        $members = $this->detailFinanceRepository
            ...
            ->join("member", "member.id", "=", "detail_finance.member_id")
            ->join("finance", "finance.id", "=", "detail_finance.finance_id")
            ->get(array("finance.month", "detail_finance.status", "detail_finance.paymentMethod", "detail_finance.created_at", "detail_finance.cash"));
